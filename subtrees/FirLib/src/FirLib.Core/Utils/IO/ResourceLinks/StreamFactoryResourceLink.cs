...
namespace SeeingSharp.Util
{
    public class StreamFactoryResourceLink : ResourceLink
    {
        ...
        {
            throw new FirLibException("Unable to read another file on a stream factory source!");
        }
        ...
        public override Stream OpenOutputStream()
        {
            ...
            {
                result.Dispose();
                throw new FirLibException("Can not write to created stream!");
            }
        ...
        public override Stream OpenInputStream()
        {
            ...
            {
                result.Dispose();
                throw new FirLibException("Can not read from created stream!");
            }
